...
export default function InvestigationPipeline({ investigation = {} }) {
    ...
    const handleAgentClick = (step) => {
        ...
        if (step.stageNumber === 1) {
            ...
            sourceId = firstTrace?.trace_id || (firstTrace?.evidence_id?.startsWith("1-") ? firstTrace.evidence_id : null) || (investigation.traces?.[0]?.trace_id) || (isMock ? "mock-trace-pay-504-01" : null);
